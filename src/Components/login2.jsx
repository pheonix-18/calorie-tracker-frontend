...
import food_thumbnail from "../food_thumbnail.jpeg";
...
export default function Login2() {
  ...
  return (
    <section className="h-screen w-screen">
      <div
        className="flex h-screen flex-row items-center flex-grow-0 bg-yellow-400  gap-1"
        style={{
          backgroundImage: `url(${food_thumbnail})`,
        ...
        <div className="flex-grow flex flex-col gap-2 items-center">
          <form onSubmit={handleLoginSubmit}>
            <div className="flex flex-row justify-center">
              <img className="h-18 w-32 mb-2" src={logo} alt="logo" />
            </div>
            ...
            <div className="flex flex-col justify-self-center items-center text-center lg:text-left">
              <div className="flex flex-row justify-between gap-4">
                <button
                  type="submit"
                  className="inline px-7 py-3 bg-pink-400 text-white font-medium text-sm leading-snug uppercase rounded shadow-md hover:bg-pink-700 hover:shadow-lg focus:bg-pink-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-pink-800 active:shadow-lg transition duration-150 ease-in-out"
                >
                  Login
                </button>
                <button
